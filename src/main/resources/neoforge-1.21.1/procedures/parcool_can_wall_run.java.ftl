...
((java.util.function.Supplier<Boolean>) () -> {
	try {
		if (${input$ENTITY} instanceof net.minecraft.server.level.ServerPlayer _serverPlayer) {
			...
			return _limitation.isPermitted(com.alrex.parcool.common.action.impl.HorizontalWallRun.class)
				|| _limitation.isPermitted(com.alrex.parcool.common.action.impl.VerticalWallRun.class);
		}
		if (${input$ENTITY} instanceof net.minecraft.world.entity.player.Player _player) {
			...
			return _info.can(com.alrex.parcool.common.action.impl.HorizontalWallRun.class)
				|| _info.can(com.alrex.parcool.common.action.impl.VerticalWallRun.class);
		}
